...
class HttpInstrumentation extends instrumentation_1.InstrumentationBase {
    ...
    _incomingRequestFunction(component, original) {
        ...
        return function incomingRequest(event, ...args) {
            ...
            const span = instrumentation._startHttpSpan(`${component.toLocaleUpperCase()} ${method} ${spanOptions.attributes['http.target']}`, spanOptions, ctx);
            const rpcMetadata = {
    ...
    _outgoingRequestFunction(component, original) {
        ...
        return function outgoingRequest(options, ...args) {
            ...
            const span = instrumentation._startHttpSpan(`${component.toUpperCase()} ${method} ${attributes['http.target']}`, spanOptions);
